...
App.Components.AppointmentsModal = (function () {
    ...
    const $filterExistingCustomers = $appointmentsModal.find('#filter-existing-customers');
    const $customerId = $appointmentsModal.find('#customer-id');
    const $firstName = $appointmentsModal.find('#first-name');
    const $lastName = $appointmentsModal.find('#last-name');
    const $email = $appointmentsModal.find('#email');
    const $phoneNumber = $appointmentsModal.find('#phone-number');
    const $address = $appointmentsModal.find('#address');
    const $city = $appointmentsModal.find('#city');
    const $zipCode = $appointmentsModal.find('#zip-code');
    const $language = $appointmentsModal.find('#language');
    const $timezone = $appointmentsModal.find('#timezone');
    const $customerNotes = $appointmentsModal.find('#customer-notes');
    const $selectCustomer = $appointmentsModal.find('#select-customer');
    const $saveAppointment = $appointmentsModal.find('#save-appointment');
    const $appointmentId = $appointmentsModal.find('#appointment-id');
    const $appointmentLocation = $appointmentsModal.find('#appointment-location');
    const $appointmentStatus = $appointmentsModal.find('#appointment-status');
    const $appointmentColor = $appointmentsModal.find('#appointment-color');
    const $appointmentNotes = $appointmentsModal.find('#appointment-notes');
