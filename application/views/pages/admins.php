...
<div class="backend-page admins-page-fullbleed" id="admins-page">
    <div class="row g-0" id="admins">
        <?php component('backend_filter_panel', [
            'filter_id' => 'filter-admins',
            'title' => lang('admins'),
            'add_button_id' => 'add-admin',
        ]); ?>
        ...
        <div class="record-details column col-12 col-md-7">
            ...
            <div class="mb-4 rounded-xl border border-[var(--bs-border-color,#e2e8f0)] bg-white p-4">
                <div class="d-flex w-100 justify-content-between gap-3">
                    <div>
                        <div class="text-lg font-medium text-slate-900" id="admin-summary-name">
                            —
                        </div>
                    </div>
                    <div id="admin-actions-group" class="d-flex align-items-start">
                        <div class="dropdown">
                    ...
                    <div id="admin-save-cancel-group" class="d-none align-items-start gap-2">
                        <button id="save-admin" class="btn btn-primary btn-sm">
                            <i class="fas fa-check-square me-2"></i>
                            <?= lang('save') ?>
                        </button>
                        <button id="cancel-admin" class="btn btn-outline-secondary btn-sm">
                            <?= lang('cancel') ?>
                        </button>
                    </div>
                </div>
            ...
            <div class="flex w-full">
                <ul class="booking-tab-line-list" id="admin-tabs" role="tablist">
                    ...
                    <?php if (vars('show_admin_forms_tab', false)): ?>
                        <li class="nav-item" role="presentation">
                            <button class="booking-tab-line" id="admin-forms-tab" data-bs-toggle="pill"
                                    data-bs-target="#admin-forms-panel" type="button" role="tab" aria-selected="false"
                                    tabindex="-1">
                                Forms
                            </button>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item" role="presentation">
                        <button class="booking-tab-line" id="admin-files-tab" data-bs-toggle="pill"
                                data-bs-target="#admin-files-panel" type="button" role="tab" aria-selected="false"
                                tabindex="-1">
                            Files
                        </button>
                    </li>
            ...
            <div class="tab-content mt-6 w-full" id="admin-tabs-content">
                ...
                <?php if (vars('show_admin_forms_tab', false)): ?>
                    <div class="tab-pane fade" id="admin-forms-panel" role="tabpanel"
                         aria-labelledby="admin-forms-tab">
                        <div class="user-forms-panel w-full" data-user-type="admin"
                ...
                <?php endif; ?>
                <div class="tab-pane fade" id="admin-files-panel" role="tabpanel"
                     aria-labelledby="admin-files-tab">
                    <div class="user-files-panel w-full" data-user-type="admin"
                        ...
                        <div class="mb-4">
                            <div class="user-files-dropzone rounded-xl border border-[var(--bs-border-color,#e2e8f0)] bg-slate-50/60 p-4 text-center d-flex flex-column align-items-center justify-content-center gap-2"
                                 role="button" tabindex="0" aria-label="Upload admin files">
