...
$dropdown_menu_class = 'dropdown-menu dropdown-menu-end mt-2 w-56 rounded-xl border border-slate-200 bg-white p-2 shadow-lg';
?>
    ...
    <div class="mx-auto flex w-full items-center justify-between px-4 py-3">
        ...
        <div id="header-menu" class="block">
            <ul class="flex flex-row items-center gap-1">
                ...
                <li class="dropdown relative md:ml-auto <?= $hidden ?>">
                    <button class="<?= $active ? $nav_link_active : $nav_link_inactive ?> gap-2"
                            type="button"
                            data-bs-toggle="dropdown"
